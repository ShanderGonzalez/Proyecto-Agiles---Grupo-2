...
public class Album implements Serializable{
     ...
     */
    public Album(String nombre, int añoLanzamiento, String disquera, String[] artistas) {
        this.nombre = nombre;
    ...
    /**
     * Devuelve la disquera del álbum.
     * 
    ...
    /**
     * Devuelve los artistas del álbum.
     * 
     * @return los artistas del álbum
     */
    ...
    /**
     * Devuelve la lista de canciones del álbum.
     * 
    ...
    public static void guardarAlbumes(List<Album> albumes) {
        try {
            try (FileOutputStream fileOut = new FileOutputStream("albumes.txt"); ObjectOutputStream out = new ObjectOutputStream(fileOut)) {
    ...
    public static List<Album> cargarAlbumes() {
        ...
        try {
            try (FileInputStream fileIn = new FileInputStream("albumes.txt"); ObjectInputStream in = new ObjectInputStream(fileIn)) {
