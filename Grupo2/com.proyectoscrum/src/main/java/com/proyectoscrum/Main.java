...
/**
 * La clase Main es la clase principal del programa que permite interactuar con
 * un almacén de álbumes de música.
 * Proporciona un menú de opciones para crear álbumes, agregar canciones a un
 * álbum, ver la lista de canciones de un álbum
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        if (duracion.equals("00:00")) {
                            System.out.println("La duración no puede ser 00:00. Intente de nuevo.\n");
                            continue;
                        }
